...
class XDetectBase(metaclass=logMeta(logger)):
    ...
    def locateBattleWarningStartButton(self):
        modal=self._crop((450,220,850,420))
        button=self._crop((700,520,990,610))
    ...
    def isCloseNotice(self):return self._compare(self.tmpl.CLOSENOTICE,(1180,0,1280,80),.10)
    def locateCloseNotice(self):return self._find(self.tmpl.CLOSENOTICE,(1180,0,1280,80),.10)
    ...
    def findNextMarker(self,rect=(0,0,1280,720)):return self._find(self.tmpl.NEXTMARKER,rect,.13)
